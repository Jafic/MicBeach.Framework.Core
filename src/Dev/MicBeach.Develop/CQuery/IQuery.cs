...
namespace MicBeach.Develop.CQuery
{
    ...
    public interface IQuery : IQueryItem
    {
        ...
        /// <returns>return newest instance</returns>
        IQuery And<T>(Expression<Func<T, dynamic>> field, CriteriaOperator @operator, dynamic value, ICriteriaConvert convert = null) where T : IQueryModel<T>;
        ...
        /// <param name="convert">criterial convert</param>
        /// <returns>return newest instance</returns>
        IQuery And<T>(QueryOperator eachFieldConnectOperator, CriteriaOperator @operator, dynamic value, ICriteriaConvert convert = null, params Expression<Func<T, dynamic>>[] fields) where T : IQueryModel<T>;
        ...
        /// <param name="convert">criterial convert</param>
        /// <returns>return newest instance</returns>
        IQuery Or<T>(Expression<Func<T, dynamic>> field, CriteriaOperator @operator, dynamic value, ICriteriaConvert convert = null) where T : IQueryModel<T>;
        ...
        /// <param name="fields">field type</param>
        /// <returns>return newest instance</returns>
        IQuery Or<T>(QueryOperator eachFieldConnectOperator, CriteriaOperator @operator, dynamic value, ICriteriaConvert convert = null, params Expression<Func<T, dynamic>>[] fields) where T : IQueryModel<T>;
        ...
        /// <param name="convert">criterial convert</param>
        /// <returns>return newest instance</returns>
        IQuery Equal<T>(Expression<Func<T, dynamic>> field, dynamic value, bool or = false, ICriteriaConvert convert = null) where T : IQueryModel<T>;
        ...
        /// <param name="convert">criterial convert</param>
        /// <returns>return newest instance</returns>
        IQuery NotEqual<T>(Expression<Func<T, dynamic>> field, dynamic value, bool or = false, ICriteriaConvert convert = null) where T : IQueryModel<T>;
        ...
        /// <param name="convert">criterial convert</param>
        /// <returns>return newest instance</returns>
        IQuery LessThan<T>(Expression<Func<T, dynamic>> field, dynamic value, bool or = false, ICriteriaConvert convert = null) where T : IQueryModel<T>;
        ...
        /// <param name="convert">criterial convert</param>
        /// <returns>return newest instance</returns>
        IQuery LessThanOrEqual<T>(Expression<Func<T, dynamic>> field, dynamic value, bool or = false, ICriteriaConvert convert = null) where T : IQueryModel<T>;
        ...
        /// <param name="convert">criterial convert</param>
        /// <returns>return newest instance</returns>
        IQuery GreaterThan<T>(Expression<Func<T, dynamic>> field, dynamic value, bool or = false, ICriteriaConvert convert = null) where T : IQueryModel<T>;
        ...
        /// <param name="convert">criterial convert</param>
        /// <returns>return newest instance</returns>
        IQuery GreaterThanOrEqual<T>(Expression<Func<T, dynamic>> field, dynamic value, bool or = false, ICriteriaConvert convert = null) where T : IQueryModel<T>;
        ...
        /// <param name="convert">criterial convert</param>
        /// <returns>return newest instance</returns>
        IQuery In<T>(Expression<Func<T, dynamic>> field, IEnumerable value, bool or = false, ICriteriaConvert convert = null) where T : IQueryModel<T>;
        ...
        /// <param name="convert">criterial convert</param>
        /// <returns>return newest instance</returns>
        IQuery NotIn<T>(Expression<Func<T, dynamic>> field, IEnumerable value, bool or = false, ICriteriaConvert convert = null) where T : IQueryModel<T>;
        ...
        /// <param name="convert">criterial convert</param>
        /// <returns>return newest instance</returns>
        IQuery Like<T>(Expression<Func<T, dynamic>> field, string value, bool or = false, ICriteriaConvert convert = null) where T : IQueryModel<T>;
        ...
        /// <param name="convert">criterial convert</param>
        /// <returns>return newest instance</returns>
        IQuery BeginLike<T>(Expression<Func<T, dynamic>> field, string value, bool or = false, ICriteriaConvert convert = null) where T : IQueryModel<T>;
        ...
        /// <param name="convert">criterial convert</param>
        /// <returns>return newest instance</returns>
        IQuery EndLike<T>(Expression<Func<T, dynamic>> field, string value, bool or = false, ICriteriaConvert convert = null) where T : IQueryModel<T>;
        ...
        /// <param name="convert">criterial convert</param>
        /// <returns>return newest instance</returns>
        IQuery Asc<T>(Expression<Func<T, dynamic>> field, ICriteriaConvert convert = null) where T : IQueryModel<T>;
        ...
        /// <param name="convert">criterial convert</param>
        /// <returns>return newest instance</returns>
        IQuery Desc<T>(Expression<Func<T, dynamic>> field, ICriteriaConvert convert = null) where T : IQueryModel<T>;
